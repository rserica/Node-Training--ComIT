...
let firstname = "Coraline";
let lastname = "Gailman";
let isAuthor = window.confirm('Would you like to be the author of this document?');
console.log(isAuthor);

if (isAuthor) {
  alert(`The author is ${firstname} ${lastname}`);
  console.log(`The author is ${firstname} ${lastname}`);
} else {
  alert("So, So, SOOO, sad.. the author is crying now... thanks");
  console.log("So, So, SOOO, sad.. the author is crying now... thanks");
}
